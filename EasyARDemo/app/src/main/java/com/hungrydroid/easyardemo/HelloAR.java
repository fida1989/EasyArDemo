...
package com.hungrydroid.easyardemo;
...
public class HelloAR
{
    ...
    public boolean initialize()
    {
        ...
        loadFromImage(tracker, "android.jpg");
                ...
                if (status == TargetStatus.Tracked) {
                    ...
                    if (tracked_target == 0) {
                        ...
                        if (video == null && video_renderers.size() > 0) {
                           ...
                           if (target_name.equals("android") && video_renderers.get(0).texId() != 0) {
                                video = new ARVideo();
                                video.openVideoFile("android.mp4", video_renderers.get(0).texId());
